...
bool    getMysteryWord1(std::string &mysteryWord)
{
    ...
    else
    {
        ...
        /*
        ** sous linux, (comme le fichier dico a ete genere sous windows),
        ** on enleve le caractere "\r" soit retour chariot qui se trouve
        ** a la fin de chaque mot du fichier pour eviter les bugs.
        ** decommenter la ligne du dessous si le correcteur est sous LINUX
        */
